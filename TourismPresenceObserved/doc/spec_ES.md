...
Entidad: TourismPresenceObserved  
===============================
<!-- /10-Header -->
...
[Licencia Abierta](https://github.com/smart-data-models//dataModel.TourismDestinations/blob/master/TourismPresenceObserved/LICENSE.md)  
...
Global description: **Observación horaria de la presencia de visitantes en un lugar específico (municipio), segmentada por nacionalidad. Cada entidad representa una hora de observación.**  
...
- `alternateName[string]`: Un nombre alternativo para este artículo  . Model: [https://schema.org/Text](https://schema.org/Text)  
- `areaServed[string]`: El área geográfica donde se aplica el servicio o los datos  . Model: [https://schema.org/Text](https://schema.org/Text)  
- `dataProvider[string]`: Proveedor de la entidad de datos armonizados  . Model: [https://schema.org/Text](https://schema.org/Text)  
...
- `dateObserved[date-time]`: Fecha y hora de esta observación horaria en formato UTC ISO8601. Debe representar el medio de la hora (por ejemplo, 10:30 para 10:00–10:59)  . Model: [https://schema.org/DateTime](https://schema.org/DateTime)  
- `description[string]`: Una descripción de este artículo  
- `district[string]`: Distrito administrativo de la ubicación  . Model: [https://schema.org/Text](https://schema.org/Text)  
...
- `locationCode[string]`: Código oficial del lugar/municipio (por ejemplo, código DICOFRE en Portugal)  . Model: [https://schema.org/Text](https://schema.org/Text)  
- `locationName[string]`: Nombre del lugar/municipio  . Model: [https://schema.org/Text](https://schema.org/Text)  
- `name[string]`: El nombre de este artículo  
- `nationality[string]`: Nacionalidad de los visitantes expresada como código de país alpha-2 ISO 3166-1 (por ejemplo, ES, FR, PT)  . Model: [https://schema.org/Text](https://schema.org/Text)  
...
- `source[string]`: Fuente original de los datos como URL  . Model: [https://schema.org/Text](https://schema.org/Text)  
- `type[string]`: Tipo de entidad NGSI. Tiene que ser TourismPresenceObserved  
- `visitorCount[number]`: Número de visitantes observados durante esta hora específica  . Model: [https://schema.org/Number](https://schema.org/Number)  
<!-- /30-PropertiesList -->
...
#### PresenciaTurísticaObservada ejemplo de valores clave NGSI-v2  

Aquí hay un ejemplo de TourismPresenceObserved en formato JSON como clave-valor. Esto es compatible con NGSI-v2 cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
...
#### PresenciaTurísticaObservada Ejemplo normalizado NGSI-v2  

Aquí hay un ejemplo de TourismPresenceObserved en formato JSON normalizado. Esto es compatible con NGSI-v2 cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### PresenciaTurísticaObservada ejemplo de valores clave NGSI-LD  

Aquí hay un ejemplo de TourismPresenceObserved en formato JSON-LD como clave-valor. Esto es compatible con NGSI-LD cuando se utiliza `options=keyValues` y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### PresenciaTurísticaObservada Ejemplo normalizado de NGSI-LD  

Aquí hay un ejemplo de TourismPresenceObserved en formato JSON-LD normalizado. Esto es compatible con NGSI-LD cuando no se utilizan opciones y devuelve los datos de contexto de una entidad individual.  
<details><summary><strong>show/hide example</strong></summary>    
