...
Entità: TourismPresenceObserved  
===============================
<!-- /10-Header -->
...
[Licenza aperta](https://github.com/smart-data-models//dataModel.TourismDestinations/blob/master/TourismPresenceObserved/LICENSE.md)  
...
Global description: **Osservazione oraria della presenza dei visitatori in una specifica località (comune), suddivisa per nazionalità. Ogni entità rappresenta un'ora di osservazione.**  
...
- `alternateName[string]`: Un nome alternativo per questo elemento  . Model: [https://schema.org/Text](https://schema.org/Text)  
- `areaServed[string]`: L'area geografica in cui si applica il servizio o i dati  . Model: [https://schema.org/Text](https://schema.org/Text)  
...
- `dateObserved[date-time]`: Data e ora di questa osservazione oraria in formato ISO8601 UTC. Dovrebbe rappresentare la metà dell'ora (ad esempio 10:30 per 10:00-10:59)  . Model: [https://schema.org/DateTime](https://schema.org/DateTime)  
- `description[string]`: Una descrizione di questo articolo  
- `district[string]`: Distretto amministrativo della località  . Model: [https://schema.org/Text](https://schema.org/Text)  
...
- `locationCode[string]`: Codice ufficiale della località/comune (ad esempio codice DICOFRE in Portogallo)  . Model: [https://schema.org/Text](https://schema.org/Text)  
- `locationName[string]`: Nome della località/comune  . Model: [https://schema.org/Text](https://schema.org/Text)  
- `name[string]`: Il nome di questo elemento  
- `nationality[string]`: Nazionalità dei visitatori espressa come codice paese alpha-2 ISO 3166-1 (ad es. ES, FR, PT)  . Model: [https://schema.org/Text](https://schema.org/Text)  
...
- `source[string]`: Origine originale dei dati come URL  . Model: [https://schema.org/Text](https://schema.org/Text)  
- `type[string]`: Tipo di entità NGSI. Deve essere TourismPresenceObserved  
- `visitorCount[number]`: Numero di visitatori osservati durante questa ora specifica  . Model: [https://schema.org/Number](https://schema.org/Number)  
<!-- /30-PropertiesList -->
...
#### PresenzaTuristicaOsservata Esempio di valori chiave NGSI-v2  

Ecco un esempio di TourismPresenceObserved in formato JSON come chiavi-valori. Ciò è compatibile con NGSI-v2 quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
...
#### PresenzaTuristicaOsservata Esempio normalizzato NGSI-v2  

Ecco un esempio di TourismPresenceObserved in formato JSON come normalizzato, compatibile con NGSI-v2 quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### PresenzaTuristicaOsservata esempio di valori chiave NGSI-LD  

Ecco un esempio di TourismPresenceObserved in formato JSON-LD come chiavi-valori. Ciò è compatibile con NGSI-LD quando si utilizza `options=keyValues` e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
...
#### PresenzaTuristicaOsservata Esempio normalizzato NGSI-LD  

Ecco un esempio di TourismPresenceObserved in formato JSON-LD come normalizzato, compatibile con NGSI-LD quando non si utilizzano opzioni e restituisce i dati di contesto di un'entità individuale.  
<details><summary><strong>show/hide example</strong></summary>    
