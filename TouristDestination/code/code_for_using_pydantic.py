...
class IncludesAttractionItem(BaseModel):
...
class TouristDestination(BaseModel):
    ...
    includesAttraction: Optional[List[IncludesAttractionItem]] = Field(
        None, description=''
    )
    location: Optional[
    ...
    type: Optional[Type6] = Field(None, description='It has to be TouristDestination')
